...
# bpath = '/Users/christian/PhD/sims/mine/SG_pore_condensation/vesicle/IST/NoRelax'
# bpath = '/nfs/scistore15/saricgrp/cvanhill/sims/SG_pore_condensation/vesicle/NoRelax'
...
# sims = glob.glob('%s/P%d/e%.1f_m%s_%.2ffrac_yes/*.xyz'%(bpath,p,e,m,frac))
# sims = glob.glob('%s/P%d/e%.1f_m%s_%.2ffrac_yes/sd*/output.xyz'%(bpath,p,e,m,frac))
